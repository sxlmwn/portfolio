...
export const Hero: React.FC<HeroProps> = ({ onOpenTerminal }) => {
  ...
  return (
    <section id="hero" className="relative w-full overflow-hidden border-b border-white/5">
      {/* Unified max-w-7xl Container so text & image scale together with other sections */}
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full min-h-screen pt-24 sm:pt-28 pb-12 flex flex-col justify-between relative">
        
        {/* Background B&W Portrait - Anchored to the right side of the container */}
        <img
          src="/hero-bw.webp"
