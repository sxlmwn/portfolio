...
export const Hero: React.FC<HeroProps> = ({ onOpenTerminal }) => {
  ...
  return (
    <section
      id="hero"
      className="hero-editorial-wrapper min-h-screen relative w-full pt-24 sm:pt-28 pb-10 px-6 sm:px-10 lg:px-16 flex flex-col justify-between overflow-hidden"
    >
      {/* Background B&W Portrait (Right/Center Positioned with Left Negative Space) */}
      <img
        src="/hero-bw.webp"
      ...
      {/* Top Left Editorial Tag & Sal Callout */}
      ...
      {/* Center Staggered Editorial Typography (Alex Graham Style Overlapping Type) */}
      <div className="relative z-10 max-w-7xl w-full mx-auto my-auto py-10 sm:py-16">
        <div className="max-w-4xl">
          ...
          {/* Subtext & Short Manifesto (Offset for Editorial Balance) */}
          <div className="mt-8 sm:mt-10 pl-2 sm:pl-8 max-w-xl">
      ...
      {/* Bottom Row: Role Tag & Social Icons in Bottom Corner (Alex Graham Layout) */}
